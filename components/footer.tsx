    ...
    <footer className="bg-secondary/50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Empowering Kenya's gig workers with AI-powered financial tools.
            </p>
          </div>

          {/* Product */}
          <div>
            <h3 className="font-semibold mb-4 text-foreground text-base">Product</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-semibold mb-4 text-foreground text-base">Company</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="#" className="hover:text-primary transition-colors">
                  About Us
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-base text-muted-foreground">© 2025 Jasho. All rights reserved.</p>
